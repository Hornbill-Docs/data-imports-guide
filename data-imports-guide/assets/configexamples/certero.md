...
:::important
The configuration example is provided as-is, and may not be suitable to import your organizations Certero asset data. We highly recommend that a Certero administrator review the filter, expand column query and mappings against your Certero account prior to using this in a production environment.
:::
